...
(function(root,factory){
  ...
  // v7.03.3.14c: field-level Level 3 evidence. This is parser metadata, not UI inference.
  ...
  const RELEASE_NOTES=[
    'v7.03.3.14c removes the duplicate loader-scoped stacked-row helper that could become undefined at runtime; the existing exported core recovery is now the single source of truth.',
