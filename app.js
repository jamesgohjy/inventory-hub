// AV Inventory Hub V6.90 — Parser reliability and regression protection
...
const V682_DEPLOYMENT_BUILD='6.90.0';
function v682MarkDeployment(){
  try{
    window.__AV_INVENTORY_VERSION__='6.90';
    ...
    if(cv)cv.textContent='v6.90';
    if(av)av.textContent='Version 6.89';
    document.documentElement.dataset.avInventoryVersion='6.90';
...
async function launch(){
  try{
    ...
    src=replaceOnce(src,"// AV Inventory Hub V6.55 — evidence-only inventory parsing and verified invoice dates","// AV Inventory Hub V6.90 — Parser reliability and regression protection",'version header');
    src=replaceOnce(src,"const APP_VERSION='6.55';","const APP_VERSION='6.90';",'APP_VERSION');
...
function v667EnsurePatchNotesUi(){
  try{
    ...
    if(cv)cv.textContent='v6.90';if(av)av.textContent='Version 6.89';
