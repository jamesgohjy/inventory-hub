// AV Inventory Hub v7.03.3.7 — freeze hotfix + cumulative patch loader
...
(function v7033WrapImports(){
  ...
  }catch(e){console.warn('v7.03.3.7 import matching wrapper skipped',e);}
})();
...
async function v7033AutoWebVerify(){
  ...
  }catch(e){console.warn('v7.03.3.7 Level 2B web verification skipped',e);}
}
...
\n`;
      ...
      console.error('AV Inventory Hub v7.03.3.7 startup error:',err);
      ...
      const msg=String(err?.message||err).replace(/[&<>]/g,s=>({'&':'&amp;','<':'&lt;','>':'&gt;'}[s]));box.innerHTML='<b>AV Inventory Hub v7.03.3.7 could not start.</b><br>No database changes were made by this loader.<br><br><code>'+msg+'</code>';document.body.appendChild(box);
    }
  }
  launch();
})();
