// AV Inventory Hub v7.03.3.14w — resolved Level 3 save
(function(){
  'use strict';
  if(window.__AV_V703314T_BOOTSTRAP_STARTED__)return;
  window.__AV_V703314T_BOOTSTRAP_STARTED__=true;
  const VERSION='7.03.3.14w',ASSET_REV='v703314w-level3-save-20260925-1';
  ...
  async function launch(){
    try{
      ...
      await loadScript('runtime-v7.03.3.14w.js?v='+key);
      ...
      window.__AV_INVENTORY_VERSION__=VERSION;window.__AV_INVENTORY_BUILD__=VERSION;window.__AV_INVENTORY_BASELINE__='direct repository modules v7.03.3.14w';
