...
assert(cv==='7.03.3.14o','Core version must be 7.03.3.14o');
assert(av===cv,'App/core version mismatch: '+av+' vs '+cv);assert(iv===cv,'Index/core version mismatch: '+iv+' vs '+cv);assert(uv==='7.03.3.14p','Upcoming version must be 7.03.3.14p');
